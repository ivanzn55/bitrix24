...
use Otus\Crmtab\Seeders\DatabaseSeeder;
...
class otus_crmtab extends CModule
{
    ...
    public function __construct()
    {
        ...
        $this->MODULE_DESCRIPTION = Loc::getMessage('OTUS_CRMTAB_INSTALL_MODULE_DESCRIPTION');
        $this->MODULE_NAME = Loc::getMessage('OTUS_CRMTAB_INSTALL_MODULE_NAME');
        $this->PARTNER_NAME = Loc::getMessage('OTUS_CRMTAB_PARTNER_NAME');
        $this->PARTNER_URI = Loc::getMessage('OTUS_CRMTAB_PARTNER_URI');
    }
    ...
    public function DoInstall(): void
    {
        if ($this->isVersionD7()) {
            ...
            throw new SystemException(Loc::getMessage('OTUS_CRMTAB_INSTALL_ERROR_VERSION'));
        }
    }
    ...
    private function addEntityElements(string $entityClass): void
    {
        ...
        if ($entityClass === TaskTable::class) {
            DatabaseSeeder::addTasks();
        }
    }
